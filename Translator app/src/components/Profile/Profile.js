...
import TranslationArea from "../Text-Translation/TranslationArea/TranslationArea";
        ...
        <main>
            ...
            <AppContainer>
                <div className="mt-5 mb-5">
                    <h1 className="animate__animated animate_bounceInDown text-center">Welcome {user} </h1>
